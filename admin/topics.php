    ...
    <div class="container content">
        ...
        <div class="action">
            ...
            <form method="post" action="<?php echo BASE_URL . 'admin/topics.php'; ?>">
                ...
                <?php if ($isEditingTopic === true): ?>
                <button type="submit" disabled class="btn myButton" name="update_topic">UPDATE</button>
                <?php else: ?>
                <button type="submit" disabled class="btn myButton" name="create_topic">Save Topic</button>
                <?php endif ?>
            </form>
        </div>
        <!-- // Middle form - to create and edit -->
