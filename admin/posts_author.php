            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="fa fa-pencil btn edit" href="create_post_author.php?edit-post=<?php echo $post['id'] ?>">
                                </a>
                        </td>
                        <td>
                            <a class="fa fa-trash btn delete" href="create_post_author.php?delete-post=<?php echo $post['id'] ?>">
                                </a>
                        </td>
                    </tr>
                    <?php endforeach ?>
