...
<div class="navbar-item has-drophas-background-primarydown is-hoverable">
  ...
  <div class="navbar-dropdown has-background-primary">
    <?php if ($_SESSION['user']['role'] == "Admin" ): ?>
            ...
            <a href="./admin/create_post.php" class="navbar-item">
              Create post
            </a>
          <?php endif ?>
          <?php if ($_SESSION['user']['role'] == "Author" ): ?>
          <a href="./admin/create_post_author.php" class="navbar-item">
            Create post
          </a>
           <a href="./admin/posts_author.php" class="navbar-item">
            Manage Post
          </a>
          <a href="./admin/users_update_author.php" class="navbar-item">
            Profile
          </a>
